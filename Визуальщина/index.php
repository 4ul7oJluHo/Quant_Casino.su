...
<html lang="ru">
  ...
  text-shadow: 0 0 5px white, 0 0 10px white, 0 0 15px white, 0 0 20px blue, 0 0 35px blue, 0 0 40px blue, 0 0 50px blue, 0 0 75px blue;">  QuantCasino  </span>
    ...
    <button class="btn btn-success" name="zareg" type="sudmit"> Зарегестироваться </button>
...
"> Добро пожаловать в  QuantCasino ! В вы можете выграть гору кванткоинов,а можете всё проиграть,  </span>
 <span style="
  color: white;
  font-size: 25px;
  text-shadow: 0 0 5px white, 0 0 10px white, 0 0 15px white, 0 0 20px blue, 0 0 35px blue, 0 0 40px blue, 0 0 50px blue, 0 0 75px blue;">поставьте свои кванткоины и заберите в 2 раза больше! </span>
      </section>
      <section>
...
{"label":"CRAH",  "value":1,  "question":"What CSS property is used for specifying the area between the content and its border?"}, // padding
